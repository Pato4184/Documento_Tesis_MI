...
\begin{figure}[H]
  ...
  \subfloat[]{
    ...
    \caption{\textbf{(a)} Flujo de calor turbulento en la dirección de la corriente. \textbf{(b)} Esquema de perfiles de temperatura y velocidad para convección forzada y mixta. \text{red}{Aquí los desplazamientos $dy^*$ hacia la izquierda están representados con flechas anaranjadas, mientras que desplazamientos a la derecha están representados con flechas negras.}}
    \label{fig:rms-Re5000-Pr071}
\end{figure}
